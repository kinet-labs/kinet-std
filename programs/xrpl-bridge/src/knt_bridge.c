 ...
 *
 * This hook implements cross-chain bridging between XRPL and Knt Network.
 ...
 *
 * Build:
 *   wasmcc knt_bridge.c -o knt_bridge.wasm
 *
 * Deploy:
...
// XRPL chain ID in Knt namespace
