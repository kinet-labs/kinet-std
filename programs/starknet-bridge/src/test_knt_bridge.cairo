...
mod tests {
    use super::KntBridge;
    use super::IKntBridge;
    use super::IKntBridgeDispatcher;
    use super::IKntBridgeDispatcherTrait;
    ...
    fn deploy_bridge(fee_bps: u16) -> IKntBridgeDispatcher {
        let contract = KntBridge::contract_state_for_testing();
        set_caller_address(admin_addr());
        KntBridge::constructor(ref contract, admin_addr(), SIGNER, fee_bps);
        // Return dispatcher wrapping the test contract state
        IKntBridgeDispatcher { contract_address: contract_address_const::<0x999>() }
    }
    ...
    fn test_constructor_sets_initial_state() {
        let mut state = KntBridge::contract_state_for_testing();
        set_caller_address(admin_addr());
        KntBridge::constructor(ref state, admin_addr(), SIGNER, 30);

        let bridge = KntBridge::KntBridgeImpl::new(ref state);
    ...
    fn test_constructor_rejects_fee_above_500() {
        let mut state = KntBridge::contract_state_for_testing();
        set_caller_address(admin_addr());
        KntBridge::constructor(ref state, admin_addr(), SIGNER, 501);
    }
    ...
    fn test_constructor_accepts_max_fee() {
        let mut state = KntBridge::contract_state_for_testing();
        set_caller_address(admin_addr());
        KntBridge::constructor(ref state, admin_addr(), SIGNER, 500);
        // Should not panic
    }
    ...
    fn test_admin_can_pause() {
        ...
        let mut bridge = KntBridge::KntBridgeImpl::new(ref state);
    ...
    fn test_lock_and_bridge_increments_nonce() {
        let mut state = KntBridge::contract_state_for_testing();
        set_caller_address(admin_addr());
        KntBridge::constructor(ref state, admin_addr(), SIGNER, 0);
    ...
    fn test_lock_and_bridge_updates_total_locked() {
        let mut state = KntBridge::contract_state_for_testing();
        set_caller_address(admin_addr());
        KntBridge::constructor(ref state, admin_addr(), SIGNER, 0); // 0 fee
    ...
    fn test_lock_and_bridge_deducts_fee() {
        let mut state = KntBridge::contract_state_for_testing();
        set_caller_address(admin_addr());
        KntBridge::constructor(ref state, admin_addr(), SIGNER, 100); // 1% fee
