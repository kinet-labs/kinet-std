/// Knt Bridge — Sui native bridge contract (Move)
///
/// Implements cross-chain token bridging between Sui and Knt Network.
...
module knt_bridge::bridge {
    ...
    // Sui chain ID in Knt bridge namespace
