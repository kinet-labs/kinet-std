...
/**
 * Tests for KntBridge — OP_NET (Bitcoin L1) bridge contract.
 *
 * These tests mock the OP_NET runtime (Blockchain, Calldata, StoredU256, etc.)
 * to validate KntBridge business logic without requiring a full OP_NET node.
 */
...
// ================================================================
// Simplified KntBridge for testing
// ================================================================

class TestableKntBridge {
...
describe('KntBridge', () => {
    let bridge: TestableKntBridge;
    let custodian: MockAddress;
    let user: MockAddress;

    beforeEach(() => {
        bridge = new TestableKntBridge();
