"""
Knt Bridge — Algorand native bridge (PyTeal/ARC-4)
...
# Algorand chain ID in Knt namespace
ALGORAND_CHAIN_ID = Int(4294967450)
MAX_FEE_BPS = Int(500)


class KntBridge(Application):
    """Knt Bridge for Algorand — lock/mint/burn/release with MPC Ed25519 signatures."""
...
if __name__ == "__main__":
    KntBridge().build().export("./artifacts")
