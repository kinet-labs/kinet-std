"""
Tests for Knt Bridge — Algorand (PyTeal/Beaker)

Run with: python -m pytest test_knt_bridge.py -v
...
from knt_bridge import KntBridge, ALGORAND_CHAIN_ID, MAX_FEE_BPS


class TestKntBridgeSchema(unittest.TestCase):
...
class TestKntBridgeCompilation(unittest.TestCase):
    ...
    def test_contract_json(self):
        ...
        self.assertEqual(contract["name"], "KntBridge")


class TestKntBridgeABI(unittest.TestCase):
...
class TestKntBridgeTEALLogic(unittest.TestCase):
...
class TestKntBridgeInitialize(unittest.TestCase):
...
class TestKntBridgeLockLogic(unittest.TestCase):
...
class TestKntBridgeBurnLogic(unittest.TestCase):
...
class TestKntBridgePauseLogic(unittest.TestCase):
