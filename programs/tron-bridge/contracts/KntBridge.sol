...
/**
 * @title Knt Bridge — TRON TVM native bridge
 ...
 * from ~/work/knt/standard/contracts/bridge/teleport/Teleporter.sol.
 *
...
contract KntBridge is ReentrancyGuard {
    using SafeERC20 for IERC20;
    using ECDSA for bytes32;

    // TRON mainnet chain ID in Knt namespace
