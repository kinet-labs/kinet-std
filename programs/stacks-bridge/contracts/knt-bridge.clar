;; Knt Bridge — Stacks (Clarity) native bridge
;;
...
(define-public (mint-bridged
    ...
    (begin
        ...
        ;; Message: SHA256("KNT_BRIDGE_MINT" || source_chain || nonce || recipient || amount)
        ;; Clarity has secp256k1-recover? built-in
        (let (
            (msg-hash (sha256 (concat
                0x4c55585f4252494447455f4d494e54  ;; "KNT_BRIDGE_MINT"
