...
import { IDEX, DEXLib } from "@kinet/contracts/precompile/interfaces/dex/IDEX.sol";
import { IOracle, OracleLib } from "@kinet/contracts/precompile/interfaces/IOracle.sol";

/// @title IQuantumSwap
/// @notice High-frequency trading interface for Knt native DEX
