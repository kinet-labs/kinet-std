 ...
 * @title BridgeV4
 * @author kinet labs
 * @notice Canonical post-quantum-default bridge entrypoint for the Knt network.
 *
...
contract BridgeV4 is AccessControl, ReentrancyGuard, Pausable {
    ...
    struct BridgeEnvelope {
        ...
        address dstAsset; // BridgedXXX contract to mint on Knt
        uint256 amount; // amount in dstAsset's raw decimals
        address recipient; // Knt address to mint to
    ...
    // ═══════════════════════════════════════════════════════════════════════
    //  CLAIM (inbound: source chain → Knt)
    // ═══════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════
    //  REDEEM (outbound: Knt → destination chain)
    // ═══════════════════════════════════════════════════════════════════════

    /**
     * @notice Burn `amount` of a bridged asset on Knt; daemon broadcaster
     ...
     * @param asset       destination bridged-asset (on Knt) — burned here
