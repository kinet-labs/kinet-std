...
/**
 * @dev Interface for bridgeable tokens (KRC20B compatible)
 */
interface IKRC20B {
 ...
 * @title Bridge
 * @author kinet labs
 * @notice MPC-based cross-chain bridge for KRC20B tokens
...
contract Bridge is Ownable, AccessControl {
    ...
    function bridgeBurn(uint256 amount, address tokenAddr) public {
        IKRC20B token = IKRC20B(tokenAddr);
    ...
    function bridgeMintStealth(
        ...
        varStruct.token = IKRC20B(tokenAddrStr);
