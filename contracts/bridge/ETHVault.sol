 ...
 * @dev Built on KRC20 (Knt Request for Comments 20)
 *      H-03 fix: Added rate limiting and emergency pause
 */
contract ETHVault is KRC20, Pausable, Ownable {
    // ═══════════════════════════════════════════════════════════════════════
    // CONSTANTS (H-03 fix)
    // ═══════════════════════════════════════════════════════════════════════
    ...
    constructor(string memory name, string memory symbol) KRC20(name, symbol) Ownable(msg.sender) { }
