# Yield Strategies for Knt Bridge

Comprehensive yield strategies for Knt bridge tokens (KETH, KBTC, KUSD, KSOL, etc.). Each bridged asset automatically earns yield from source chain DeFi protocols.
...
| [BabylonStrategy.sol](./BabylonStrategy.sol) | Babylon BTC Staking, Lombard KBTC | Bitcoin → Ethereum | ✅ |
...
| Lombard KBTC | `BabylonStrategy.sol` | KBTC | 3-5% | Low | Liquid BTC staking |
...
│  Kinet Network                           ▼                                    │
│  ┌─────────────────────────────────────────────────────────────────────────┐│
│  │           YieldBearingBridgeToken.sol (yKETH, yKBTC, yKUSD)            ││
│  │                                                                         ││
