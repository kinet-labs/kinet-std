 ...
 * This strategy wraps BabylonStaking for the BTC held on the Knt side.
 *
 * Flow:
 * 1. User locks BTC in OP_NET bridge contract (btc-runtime)
 * 2. MPC attests deposit, Teleporter mints KBTC on Knt
 * 3. Vault deposits KBTC into this strategy
...
contract OPNETStrategy is IYieldStrategy, Ownable {
    ...
    /// @notice BTC token (KBTC bridged from OP_NET)
     ...
     * @param _btcToken KBTC token address (bridged from OP_NET)
