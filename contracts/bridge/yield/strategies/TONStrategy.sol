...
interface ITONBridge {
    ...
    /// @param amount Amount of KTON/wrapped TON to lock
...
abstract contract BaseTONStrategy is Ownable, ReentrancyGuard {
    ...
    /// @notice KTON (Knt-wrapped TON) token
    ...
    /// @notice Total deposited in KTON terms
    ...
    /// @notice Bridge KTON to TON blockchain
...
contract TONStrategyFactory is Ownable {
    ...
    /// @notice Set KTON token address
    function setKTON(address _lton) external onlyOwner {
        lton = _lton;
