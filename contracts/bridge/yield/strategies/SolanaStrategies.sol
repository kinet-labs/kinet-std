...
abstract contract SolanaStrategyBase is Ownable, ReentrancyGuard {
    ...
    /// @notice Wrapped SOK token on EVM (wSOL from Wormhole)
     ...
     * @param _wSOL Wrapped SOK token address
...
contract MarinadeStrategy is SolanaStrategyBase {
    ...
    /// @notice mSOK token representation on EVM (Wormhole wrapped)
     ...
     * @param _oracle Solana yield oracle address
     * @param _wSOL Wrapped SOK token address
     * @param _wMSOL Wrapped mSOK token address
...
contract JitoStrategy is SolanaStrategyBase {
    ...
    /// @notice JitoSOK token representation on EVM (Wormhole wrapped)
     ...
     * @param _oracle Solana yield oracle address
     * @param _wSOL Wrapped SOK token address
     * @param _wJitoSOL Wrapped JitoSOK token address
     * @param _solanaReceiver Solana receiver pubkey
     */
    constructor(
        address _vault,
