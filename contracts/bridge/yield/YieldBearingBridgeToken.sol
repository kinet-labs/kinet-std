 ...
 *        ╚═╝   ╚═╝╚══════╝╚══════╝╚═════╝     ╚═════╝ ╚═╝  ╚═╝╚═╝╚═════╝  ╚═════╝ ╚══════╝
 *
 *     Yield-Bearing Bridge Token (yKETH, yKBTC, yKUSD, etc.)
 *
 *     Features:
...
/**
 * @title yKETH - Yield-Bearing Bridged ETH
 * @notice ETH bridged from Ethereum, earning staking yield (Lido, Rocket Pool, Aave)
 */
contract yKETH is YieldBearingBridgeToken {
...
/**
 * @title yKBTC - Yield-Bearing Bridged BTC
 * @notice BTC bridged, earning yield (eventually Babylon staking, or lending)
 */
contract yKBTC is YieldBearingBridgeToken {
    constructor(address _bridge, address _feeReceiver)
        YieldBearingBridgeToken(
...
/**
 * @title yKUSD - Yield-Bearing Bridged USD
 * @notice USD stablecoins bridged, earning yield (Curve, Aave, Compound)
 */
contract yKUSD is YieldBearingBridgeToken {
    constructor(address _bridge, address _feeReceiver)
        YieldBearingBridgeToken(
...
/**
 * @title yKSOL - Yield-Bearing Bridged SOL
 * @notice SOL bridged from Solana, earning staking yield (Marinade, Jito)
 */
contract yKSOL is YieldBearingBridgeToken {
    constructor(address _bridge, address _feeReceiver)
        YieldBearingBridgeToken(
