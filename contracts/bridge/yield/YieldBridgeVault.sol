 ...
 * 4. Yield accumulates and is periodically reported to Knt
 * 5. Yield distributed to KETH holders or protocol treasury
 */
contract YieldBridgeVault is Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Deposit assets when user bridges to Knt
    ...
    /**
     * @notice Withdraw assets when user bridges back from Knt
