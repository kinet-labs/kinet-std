...
contract YieldBridgeConfig is Ownable {
    ...
    struct AssetConfig {
        address yieldToken; // Yield-bearing token on Knt (yKETH, etc.)
        address bridgeToken; // Regular bridge token (KETH, etc.)
     ...
     * @param yieldToken Yield-bearing token address on Knt
     * @param bridgeToken Regular bridge token address on Knt
