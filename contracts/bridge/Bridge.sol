...
contract Bridge is Ownable, AccessControl, ReentrancyGuard {
    ...
    /**
     * @dev Transfers the msg.senders coins to Knt vault
    ...
    function bridgeBurn(uint256 amount_, address tokenAddr_) public nonReentrant {
        ...
        teleport.token = KRC20B(tokenAddr_);
     ...
     * @param tokenAmount_ token amount that is transfered to knt vault in source chain
    ...
    function previewBridgeStealth(
        ...
        teleport.token = KRC20B(toTokenAddress_);
    ...
    function bridgeMintStealth(
        ...
        // Check if signer is MPCOracle and corresponds to the correct KRC20B
