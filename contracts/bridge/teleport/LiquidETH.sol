 ...
 * - KETH: Liquid token (minted by this vault)
 *
 * Flow:
 ...
 * - Debt: KETH (liquid token, minted by vault)
...
contract LiquidETH is Ownable, AccessControl, ReentrancyGuard {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // BORROW / REPAY (KETH Liquid Token)
    // ═══════════════════════════════════════════════════════════════════════

    /**
     * @notice Borrow KETH against ETH collateral
     * @param amount Amount of KETH to borrow (liquid token minted to user)
     */
