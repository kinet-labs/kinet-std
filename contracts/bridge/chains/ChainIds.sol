...
/// @title Omnichain Registry — Every chain Knt Bridge can reach
...
library ChainIds {
    // ================================================================
    //  KNT NETWORK (home chains)
    // ================================================================
    uint64 constant KNT_MAINNET = 96369;
    uint64 constant KNT_TESTNET = 96368;
    uint64 constant KNT_DEVNET = 96370;
    uint64 constant KNT_SPC = 36911;
    uint64 constant KNT_SPC_TESTNET = 36910;
    uint64 constant KNT_PARS = 494949;
    uint64 constant KNT_PARS_TESTNET = 494950;
    uint64 constant KNT_PARS_DEVNET = 494951;
