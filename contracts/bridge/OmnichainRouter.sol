...
contract OmnichainRouter is ReentrancyGuard {
    ...
    /// @notice Registered bridge tokens (KETH, KBTC, KUSD, etc.)
    ...
    /// @param _stakeholderVault Fee recipient (xKNT on Knt, LQDTY stakers on Liquidity, etc.)
...
/// @notice Interface for bridge tokens (KETH, KBTC, KUSD, etc.)
