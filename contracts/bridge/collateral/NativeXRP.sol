 ...
 * @author kinet labs
 * @notice 1:1 bridged XRP (XRP Ledger native) under MPC custody, minted on Knt
 * @dev XRP basket — sole member, matches the XRP broadcaster agent in kinet/bridge.
 *
 * Decimals: 6 — preserves drop parity (1 XRP = 1e6 drops).
 */
contract BridgedNativeXRP is KRC20B {
