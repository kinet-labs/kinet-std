 ...
 * @title Bridged USDC
 * @author kinet labs
 * @notice 1:1 bridged USDC collateral on Knt (minted by Teleporter)
 * @dev Bridged USDC can be deposited into LiquidUSD to borrow KUSD
 */
contract BridgedUSDC is KRC20B {
