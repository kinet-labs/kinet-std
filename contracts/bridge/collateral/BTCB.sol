 ...
 * @title Bridged BTCB
 * @author kinet labs
 * @notice 1:1 bridged Binance-Pegged BTC (BSC's BTCB) collateral on Knt
 ...
 * cleanly with the source-chain reserve. Normalization to KBTC's 8-decimal
 * sat parity happens in LiquidBTCPool.deposit().
 */
contract BridgedBTCB is KRC20B {
