...
import { EnumerableSet } from "@kinet/contracts/utils/Utils.sol";
 ...
 * - All L* tokens (KUSD, KETH, KBTC, etc.) can be whitelisted
...
contract CollateralRegistry is Ownable {
    ...
    enum RiskTier {
        TIER_1, // Native ecosystem (KUSD, KETH, CYRUS, MIGA, PARS)
    ...
    /// @notice Primary collateral (e.g., KUSD) - target for swaps
