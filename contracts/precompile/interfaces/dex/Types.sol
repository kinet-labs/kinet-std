...
// =========================================================================
// Currency - Represents a token (native or KRC20)
// =========================================================================

/// @notice Represents a currency (native KNT or KRC20 token)
/// @dev address(0) represents native KNT
...
library CurrencyLib {
    ...
    /// @notice Check if currency is native KNT
