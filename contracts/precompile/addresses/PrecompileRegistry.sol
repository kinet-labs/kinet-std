...
/// @notice Central registry of all Knt precompile addresses aligned with LP numbering (LP-0099)
/// @dev Address scheme: BASE (0x10000) + 16-bit selector (0xPCII)
/// @dev   P = Family page (aligned with LP-Pxxx range)
/// @dev   C = Chain slot (0=P, 1=X, 2=C, 3=Q, 4=A, 5=B, 6=Z, 7=M, A=SPC)
...
library PrecompileRegistry {
    ...
    /// @notice LSS (Knt Secret Sharing) on C-Chain
    address internal constant LSS_C = 0x0000000000000000000000000000000000015210;
    /// @notice LSS (Knt Secret Sharing) on Q-Chain
    ...
    /*//////////////////////////////////////////////////////////////
              ...
              Same address on ALL Knt EVM chains (C-Chain, SPC)
    //////////////////////////////////////////////////////////////*/
    ...
    /// @param c Chain slot (0=P, 1=X, 2=C, 3=Q, 4=A, 5=B, 6=Z, 7=M)
    /// @param ii Item index
    ...
    /// @notice Check if address is in Knt precompile range
    function isKntPrecompile(address addr) internal pure returns (bool) {
        uint256 addrInt = uint256(uint160(addr));
        // Knt precompiles: 0x10000 - 0x1FFFF (BASE + 16-bit selector)
