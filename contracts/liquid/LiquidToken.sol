...
import { KRC20 } from "@kinet/contracts/tokens/KRC20.sol";
...
/// @title LiquidToken
/// @author kinet labs
/// @notice Base contract for Knt liquid tokens (KUSD, KETH, KBTC)
/// @dev Mintable tokens with flash loan support and role-based access
/// @custom:security-contact security@knt.network
contract LiquidToken is AccessControl, ReentrancyGuard, KRC20, IERC3156FlashLender {
    // ═══════════════════════════════════════════════════════════════════════════
    // CONSTANTS
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    constructor(string memory _name, string memory _symbol, uint256 _flashFee) KRC20(_name, _symbol) {
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // OVERRIDES (resolve AccessControl/KRC20 conflict)
    // ═══════════════════════════════════════════════════════════════════════════

    /// @dev Override _msgSender to resolve conflict between Context (from AccessControl) and KRC20
