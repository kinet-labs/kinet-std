...
import { IERC1404, IERC1404Extended } from "@kinet/contracts/securities/erc1404/IERC1404.sol";

/// @title SecurityToken
/// @notice Knt's canonical ERC-3643 security token. Implements the T-REX `IToken`
...
contract SecurityToken is IToken, IERC1404Extended, ERC20, AccessControl {
    ...
    string private constant _VERSION = "knt-1.0.0";
