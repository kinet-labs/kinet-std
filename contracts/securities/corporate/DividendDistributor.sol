...
// Knt Standard Library — Securities Module
//
// Originally based on Arca Labs ST-Contracts (https://github.com/arcalabs/st-contracts)
//
// Copyright (c) 2026 kinet labs — https://knt.network
 ...
 *
 * Dividends can be paid in any ERC-20 (e.g., USDC, KNT) or native currency.
