 ...
 * @dev Implements on-chain DID registry and resolution for Kinet Network
 */
...
enum ServiceType {
    ...
    WarpMessenger, // Knt Warp messaging service
    Custom
}
...
struct DIDDocument {
    string did; // Full DID string (e.g., "did:knt:alice")
...
interface IDIDRegistry {
     ...
     * @param method DID method (e.g., "knt", "ai")
...
interface IDIDResolver {
     ...
     * @param method The DID method (e.g., "knt", "ai")
 ...
 * ├─────────────────────────────────────────────────────────────────┤
 * │  1 char  │  Ultra Premium  │  1000 tokens     │  did:knt:a     │
 * │  2 chars │  Super Premium  │  100 tokens      │  did:knt:ai    │
 * │  3 chars │  Premium        │  10 tokens       │  did:knt:bob   │
 * │  4 chars │  Standard       │  1 token         │  did:knt:john  │
 * │  5+ chars│  Basic          │  0.1 tokens      │  did:knt:alice │
 * └─────────────────────────────────────────────────────────────────┘
 */
 ...
 * │                                                                 │
 * │  {                                                              │
 * │    "id": "did:knt:alice#x402-payment",                         │
 * │    "type": "X402PaymentEndpoint",                              │
 * │    "serviceEndpoint": "https://pay.alice.knt/x402",            │
 * │    "acceptedTokens": ["KNT", "USDC", "ETH"],                   │
 * │    "facilitator": "did:knt:ai-facilitator"                  │
 * │  }                                                              │
 * └─────────────────────────────────────────────────────────────────┘
 */
