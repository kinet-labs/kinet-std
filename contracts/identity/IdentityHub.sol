...
/**
 * @title IdentityHub - Native Identity Layer for Kinet Network
 ...
 * │  - Karma accrues on primary chain (Knt)                         │
...
contract IdentityHub is AccessControl, ReentrancyGuard {
    ...
    /// @notice Network name (knt, asha, cyrus, miga, pars)
     ...
     * @param _networkName Network identifier (knt, asha, cyrus, miga, pars)
     ...
     * @param identifier DID identifier (e.g., "alice" for did:knt:alice)
