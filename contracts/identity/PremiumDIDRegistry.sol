 ...
 * @dev Deployable on Knt networks with network-specific configuration
 *
 * PRICING TIERS:
 * ┌─────────────────────────────────────────────────────────────────────────────┐
 * │  Length  │  Price (Native Token)  │  Examples                              │
 * ├─────────────────────────────────────────────────────────────────────────────┤
 * │  1 char  │  1000 tokens           │  did:knt:a                │
 * │  2 chars │  100 tokens            │  did:knt:ab                │
 * │  3 chars │  10 tokens             │  did:knt:bob            │
 * │  4 chars │  1 token               │  did:knt:john            │
 * │  5+ chars│  0.1 tokens            │  did:knt:alice       │
 * └─────────────────────────────────────────────────────────────────────────────┘
 *
 * NETWORK DEPLOYMENTS:
 * ┌─────────────────────────────────────────────────────────────────────────────┐
 ...
 * ├─────────────────────────────────────────────────────────────────────────────┤
 * │  Knt       │  knt     │  KNT           │  96369 (mainnet), 96368 (testnet)  │
 * └─────────────────────────────────────────────────────────────────────────────┘
 *
...
contract PremiumDIDRegistry is IDIDRegistry, AccessControl, ReentrancyGuard {
     ...
     * @param _network Network name (knt)
     * @param _method DID method (knt)
