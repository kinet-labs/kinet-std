...
/**
 * @title DIDRegistry - On-Chain W3C DID Registry for Kinet Network
 ...
 * ┌─────────────────────────────────────────────────────────────────────────────┐
 * │  did:knt:<identifier>                                                       │
 * │  did:knt:mainnet:<address>                                                  │
 * │  did:knt:testnet:<address>                                                  │
 * │  did:ai:<username>                                                       │
 * │  did:ai:eth:<address>                                                    │
 * └─────────────────────────────────────────────────────────────────────────────┘
 *
...
contract DIDRegistry is IDIDRegistry, AccessControl, ReentrancyGuard {
    ...
    /// @notice DID method for this registry (e.g., "knt")
     ...
     * @param _method DID method this registry handles (e.g., "knt")
