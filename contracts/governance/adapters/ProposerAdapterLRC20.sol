...
/**
 * @title ProposerAdapterKRC20
 * @author kinet labs
 * @notice Proposer eligibility based on KRC20 voting power
 ...
 */
contract ProposerAdapterKRC20 is IProposerAdapter, ERC165, Initializable {
    // ======================================================================
    // STATE VARIABLES
    // ======================================================================
     ...
     * @custom:storage-location erc7201:knt.governance.proposer.krc20
     */
     ...
     * @param data Ignored for KRC20 adapters
