...
/**
 * @title VotingWeightKRC20
 * @author kinet labs
 * @notice Voting weight calculator for KRC20 tokens (Knt ERC20 standard)
 ...
 */
contract VotingWeightKRC20 is IVotingWeight, ERC165, Initializable {
    // ======================================================================
    // STATE VARIABLES
    // ======================================================================
     ...
     * @custom:storage-location erc7201:knt.governance.votingweight.krc20
     */
     ...
     * @param voteData Ignored for KRC20 (no token IDs needed)
     ...
     * @param voter The voter address
     * @param timestamp The timestamp to calculate weight at
     * @param voteData Ignored for KRC20
     * @return weight The voting weight
     */
