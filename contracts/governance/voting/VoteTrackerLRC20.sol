...
/**
 * @title VoteTrackerKRC20
 * @author kinet labs
 * @notice Vote tracking for KRC20 token voting
 ...
 */
contract VoteTrackerKRC20 is IVoteTracker, ERC165, Initializable {
    // ======================================================================
    // STATE VARIABLES
    // ======================================================================
     ...
     * @custom:storage-location erc7201:knt.governance.votetracker.krc20
     */
