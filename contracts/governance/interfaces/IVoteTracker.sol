 ...
 * - KRC20: Simple address-based tracking (one vote per address)
 * - KRC721: Token ID-based tracking (prevent reuse of specific NFTs)
 *
 * Renamed from IVoteTrackerV1 to align with Knt naming.
 */
