 ...
 * @title Council
 * @author kinet labs
 * @notice Core governance module for Knt DAOs integrated with Gnosis Safe
 ...
 *
 * Renamed from ModuleAzoriusV1 to align with Knt naming conventions.
 *
...
contract Council is ICouncil, Secretariat, Ownable2StepUpgradeable, UUPSUpgradeable, ERC165 {
     ...
     * @custom:storage-location erc7201:Knt.Council.main
     */
     ...
     * keccak256(abi.encode(uint256(keccak256("Knt.Council.main")) - 1)) & ~bytes32(uint256(0xff))
     */
