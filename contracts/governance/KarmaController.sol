 ...
 * │  └─> Uses MPC signatures to attest Karma from Knt                           │
 * │                                                                             │
 ...
 * │                                                                             │
 * │  All WRITE operations go through Knt primary:                               │
 * │  - earnKarma, giveKarma, purgeKarma                                         │
 * │  - Cross-chain calls bridge to Knt for execution                            │
 * └─────────────────────────────────────────────────────────────────────────────┘
 */
