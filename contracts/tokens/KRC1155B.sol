 ...
 *     ╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚═╝ ╚═╝╚══════╝╚══════╝╚═════╝
 *
 *     KRC1155B - Bridge-compatible multi-token base using KRC1155 standards
 */

import { KRC1155 } from "./KRC1155/KRC1155.sol";
import { Ownable } from "@openzeppelin/contracts/access/Ownable.sol";

/**
 * @title KRC1155B
 * @notice Bridge-compatible multi-token base contract
 * @dev Extends KRC1155 with bridge mint/burn capabilities for cross-chain transfers
 */
contract KRC1155B is KRC1155, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, string memory baseURI_)
        KRC1155(name_, symbol_, baseURI_, address(0), 0)
        Ownable(msg.sender)
    {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view override(KRC1155) returns (bool) {
