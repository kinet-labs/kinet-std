 ...
 * @title KRC20Burnable
 * @author kinet labs
 * @notice KRC-20 extension for token burning (LP-3021)
 * @dev Composable extension that can be inherited alongside KRC20
 */
abstract contract KRC20Burnable is ERC20 {
    /**
