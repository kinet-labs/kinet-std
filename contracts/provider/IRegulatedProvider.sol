...
/// @notice Any Knt exchange fork can OPTIONALLY delegate regulated-asset
///         flow (security tokens, wrapped ETFs, tokenized equities) to an
///         external provider that implements this interface.
///
/// The Knt exchange itself remains permissionless and jurisdiction-neutral.
...
/// transfer agents, ATS operators). They live outside this repo. The Knt
...
interface IRegulatedProvider {
    ...
    ///         openly on Knt native liquidity.
