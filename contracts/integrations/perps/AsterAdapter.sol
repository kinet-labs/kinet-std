...
contract KntAsterAdapter is Ownable, ReentrancyGuard {
    ...
    /// @notice Knt broker ID for referral tracking
    uint256 public constant KNT_BROKER_ID = 0; // No referral ID registered — set via governance when available
