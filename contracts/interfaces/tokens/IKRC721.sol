 ...
 * @notice Knt Request for Comments 721 - Non-fungible token interface
 * @dev Extends IERC721 for full ERC-721 compatibility while establishing Knt naming.
 *
 * KRC721 tokens are fully ERC-721 compatible. This interface exists to:
 * - Establish Knt-specific naming conventions
 * - Provide a base for future Knt-specific extensions
 * - Signal that the token follows Kinet Network standards
 *
 * All KRC721 implementations support standard ERC-721 operations.
 */
interface IKRC721 is IERC721 {
...
/**
 * @title IKRC721Metadata
 * @notice KRC721 with metadata extension
 */
interface IKRC721Metadata is IKRC721, IERC721Metadata {
...
/**
 * @title IKRC721Enumerable
 * @notice KRC721 with enumerable extension
 */
interface IKRC721Enumerable is IKRC721, IERC721Enumerable {
