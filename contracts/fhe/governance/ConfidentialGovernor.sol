...
import { IConfidentialKRC20Votes } from "./IConfidentialKRC20Votes.sol";
...
abstract contract ConfidentialGovernor is Ownable2Step, TFHEApp {
    ...
    /// @dev    It is set at 100,000, which is 1% of the total supply of the ConfidentialKRC20Votes token.
    ...
    /// @dev    It is set at 400,000, which is 4% of the total supply of the ConfidentialKRC20Votes token.
    ...
    /// @notice ConfidentialKRC20Votes governance token.
    IConfidentialKRC20Votes public immutable CONFIDENTIAL_KRC20_VOTES;
     ...
     * @param confidentialKRC20Votes_   ConfidentialKRC20Votes token.
    ...
    constructor(
        address owner_,
        address timelock_,
        address confidentialKRC20Votes_,
        uint256 votingPeriod_,
        uint256 maxDecryptionDelay_
    ) Ownable(owner_) {
        TIMELOCK = ICompoundTimelock(timelock_);
        CONFIDENTIAL_KRC20_VOTES = IConfidentialKRC20Votes(confidentialKRC20Votes_);
    ...
    function propose(
        ...
        euint64 priorVotes = CONFIDENTIAL_KRC20_VOTES.getPriorVotesForGovernor(msg.sender, block.number - 1);
    ...
    function _castVote(address voter, uint256 proposalId, ebool support) internal virtual {
        ...
        euint64 votes = CONFIDENTIAL_KRC20_VOTES.getPriorVotesForGovernor(voter, proposal.startBlock);
