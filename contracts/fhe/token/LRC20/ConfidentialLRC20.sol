...
import { IConfidentialKRC20 } from "./IConfidentialKRC20.sol";
import { TFHEErrors } from "../../utils/TFHEErrors.sol";

/**
 * @title   ConfidentialKRC20.
 * @notice  This contract implements an encrypted KRC20-like token with confidential balances using
 *          KntFHE's Fully Homomorphic Encryption library.
 * @dev     It supports standard KRC20 functions such as transferring tokens, minting,
 *          and setting allowances, but uses encrypted data types.
 *          The total supply is not encrypted.
 */
abstract contract ConfidentialKRC20 is IConfidentialKRC20, IERC20Errors, TFHEErrors {
    ...
    /**
     * @notice See {IConfidentialKRC20-approve}.
     */
    ...
    /**
     * @notice See {IConfidentialKRC20-transfer}.
     */
    ...
    /**
     * @notice See {IConfidentialKRC20-transferFrom}.
     */
    ...
    /**
     * @notice See {IConfidentialKRC20-allowance}.
     */
    ...
    /**
     * @notice See {IConfidentialKRC20-balanceOf}.
     */
    ...
    /**
     * @notice See {IConfidentialKRC20-decimals}.
     */
    ...
    /**
     * @notice See {IConfidentialKRC20-name}.
     */
    ...
    /**
     * @notice See {IConfidentialKRC20-symbol}.
     */
    ...
    /**
     * @notice See {IConfidentialKRC20-totalSupply}.
     */
