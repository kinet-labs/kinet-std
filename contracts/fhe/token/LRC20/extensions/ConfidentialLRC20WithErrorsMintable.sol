...
import { ConfidentialKRC20WithErrors } from "./ConfidentialKRC20WithErrors.sol";

/**
 * @title   ConfidentialKRC20WithErrorsMintable.
 * @notice  This contract inherits ConfidentialKRC20WithErrors.
 * @dev     It allows an owner to mint tokens. Mint amounts are public.
 */
abstract contract ConfidentialKRC20WithErrorsMintable is Ownable2Step, ConfidentialKRC20WithErrors {
    /**
    ...
    constructor(string memory name_, string memory symbol_, address owner_)
        Ownable(owner_)
        ConfidentialKRC20WithErrors(name_, symbol_)
    { }
