...
/**
 * @title   ConfidentialKRC20Mintable.
 * @notice  This contract inherits ConfidentialKRC20.
 * @dev     It allows an owner to mint tokens. Mint amounts are not encrypted.
 */
abstract contract ConfidentialKRC20Mintable is Ownable2Step, ConfidentialKRC20 {
    /**
