...
import { ConfidentialKRC721 } from "../ConfidentialKRC721.sol";
import { Ownable2Step, Ownable } from "@openzeppelin/contracts/access/Ownable2Step.sol";

/**
 * @title ConfidentialKRC721Mintable
 * @author kinet labs
 * @notice Mintable extension for ConfidentialKRC721
 * @dev Adds owner-controlled minting and burning with encrypted ownership
 */
abstract contract ConfidentialKRC721Mintable is ConfidentialKRC721, Ownable2Step {
    ...
    constructor(string memory name_, string memory symbol_, address owner_, string memory baseURI_)
        ConfidentialKRC721(name_, symbol_)
        Ownable(owner_)
    {
