...
import { IConfidentialKRC721 } from "./IConfidentialKRC721.sol";
import { TFHEErrors } from "../../utils/TFHEErrors.sol";

/**
 * @title ConfidentialKRC721
 * @author kinet labs
 * @notice KRC721 NFT with encrypted ownership using KntFHE
 ...
 */
abstract contract ConfidentialKRC721 is IConfidentialKRC721, TFHEErrors {
    // ============================================================
    // STATE
    // ============================================================
    ...
    /// @inheritdoc IConfidentialKRC721
